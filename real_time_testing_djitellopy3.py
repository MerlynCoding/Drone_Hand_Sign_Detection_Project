# -*- coding: utf-8 -*-
"""
Created on Fri Aug  2 21:45:05 2024
...
def is_empty_string(my_variable):  
    if my_variable == "":  
        return True  
    else:  
        return False
...
speech_config = speechsdk.SpeechConfig(
  subscription="7ecb1272ca8243b5b15249879b7793cb", 
  region="eastus"
)
...
# Wait for password to start
password = "334455"  # Replace with your desired password

print("Please say the password to start the drone...")

while True:
    speech_result = speech_recognizer.recognize_once_async().get()
    if is_empty_string(speech_result.text):  
        print("This is an empty string.")  
    else:        
        print("Speech result:", speech_result.text)
        if speech_result.text[:-1].strip() == password:
            print("Password correct. Starting the drone...")
            break
        else:
